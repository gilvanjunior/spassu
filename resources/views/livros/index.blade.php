...
@section('content')
    <x-adminlte-card class="shadow">
        ...
        <form action="" id="form_cadastrar_atualizar" method="POST">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <x-adminlte-select name="id_autor" label="Autor" enable-old-support>
                ...
                <div class="col-sm-6">
                    <x-adminlte-select name="id_assunto" label="Assunto" enable-old-support>
                ...
                <div class="col-sm-6">
                    <x-adminlte-input type="text" name="preco" id="preco" label="Preço" placeholder="Preço" enable-old-support></x-adminlte-input>
                </div>
            </div>
